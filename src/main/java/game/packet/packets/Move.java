...
//                        object = (new FileHelper()).createInstanceOfClass("game.datastructures." + split[4]);
        ...
        result[0] = MathHelper.clamp(result[0], 0, obj.getConnectedLobby().getServerSettings().getMapWidth().getVal());
        result[1] = MathHelper.clamp(result[1], 0, obj.getConnectedLobby().getServerSettings().getMapHeight().getVal());
